...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.45]{images/fig_chapter4/nn_related/predicted_vs_ground_truth_cnn.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.45]{images/fig_chapter4/nn_related/error_in_predicted_vs_ground_truth_cnn.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.8]{images/fig_chapter2/nns/resnet_mt.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.45]{images/fig_chapter4/nn_related/predicted_vs_ground_truth_resnet.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.45]{images/fig_chapter4/nn_related/error_in_predicted_vs_ground_truth_resnet.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.45]{images/fig_chapter4/nn_related/predicted_vs_ground_truth_transformer.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.45]{images/fig_chapter4/nn_related/error_in_predicted_vs_ground_truth_transformer.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.6]{images/fig_chapter4/nn_related/rough_mo_smooth_gt.pdf}
